...
// import HelloHello from '@emp/react-base/components/Hello'
...
const App = () => (
  <>
    <Hello compiler="TypeScript 4" framework="React Project" />
    <div style={{ backgroundColor: '#eee', padding: '20px' }}>
      <h2>remote import load one!!</h2>
      <HelloDEMO />
      <h2>remote lazy load</h2>
      <React.Suspense fallback={<div />}>{/* <Hello2 /> */}</React.Suspense>
